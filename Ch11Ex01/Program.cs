...
namespace Ch11Ex01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Array collection contain {animalArray.Length} objects");
            animalArray[0].Feed();
            ((Chicken)animalArray[1]).LayEgg();

            Console.WriteLine();

            Console.WriteLine("Create an ArryList type collection of Animal " +
                "objects and use it.");
            ...
            Console.WriteLine($"Array collection contain {animalArrayList.Count} objects");
